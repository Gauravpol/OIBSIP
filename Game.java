    ...
    public static void playGame() {
        ...
        try {
            ...
            while (playAgain) {
                ...
                int Number = 1 + (int) (100 * Math.random()); // random number between 1 to 100
                int guessCount = 0; // limit of attempts is 5
                boolean gameOver = false;

                while (!gameOver && guessCount < 5) {

                    String s = JOptionPane.showInputDialog("Enter your guess");
                    ...
                    if (guess == Number) {
                        ...
                        JOptionPane.showMessageDialog(null, "Congratulations You Win Game");

                        gameOver = true;
                        scorePlayer++; // counting player score

                    } else if (guess < Number) {
                        JOptionPane.showMessageDialog(null, "Your guessed " + guess + " is too low");

                    } else {
                        JOptionPane.showMessageDialog(null, "Your guessd " + guess + " is too high");
                ...
                if (playAgain = playAgainInput.equals("yes")) {
                    ...
                    JOptionPane.showMessageDialog(null, "Please Enter valid Answer ", "Warning",
            ...
            if (scorePlayer < scoreComputer) {
                ...
                JOptionPane.showMessageDialog(null, "Computer Win Game!");

            } else {
                JOptionPane.showMessageDialog(null, "Congratulations You the Win Game!");
